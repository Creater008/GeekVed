...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><a href="./" class="button123">SOCIAL SCIENCE BOOKS</a></p>
...
$result4 = mysql_query("SELECT * FROM book where username='Social Science'");
			...
			while($row4 = mysql_fetch_array($result4))
			{
				...
				echo '<a href="./uploads/Social Science/'.$row4['book'].'" class="bookdownload"> Download</a></div></p>';
			echo '<br />';
			}
echo'
</div>
