...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><a href="./" class="button123">PHYSICS BOOKS</a></p>
...
$result4 = mysql_query("SELECT * FROM book where username='physics'");
			...
			while($row4 = mysql_fetch_array($result4))
			{
				...
				echo '<a href="./uploads/physics/'.$row4['book'].'" class="bookdownload"> Download</a></div></p>';
			echo '<br />';
			}
echo'
</div>
