...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><a href="./" class="button123">ELECTRICAL ENGINEERING BOOKS</a></p>
...
$result4 = mysql_query("SELECT * FROM book where username='Electrical Engineering'");
			...
			while($row4 = mysql_fetch_array($result4))
			{
				...
				echo '<a href="./uploads/Electrical Engineering/'.$row4['book'].'" class="bookdownload"> Download</a></div></p>';
			echo '<br />';
			}
echo'
</div>
